...
1) What is the rule Python follows to determine the scope of a variable?

a)STACK: Static, Temporary, Active, Constant, Keyword

b)TREE: Temporary, Reserved, Enclosing, External

c)LEGB: Local, Enclosing, Global, Built-in

d)SCOPE: Script, Constant, Outer, Python, Embedded
...
d)Allows modifying a variable from an enclosing function


3)Which keyword can you use to modify a global variable in Python?
...
ans
1)c)LEGB: Local, Enclosing, Global, Built-in
2)d)Allows modifying a variable from an enclosing function
3)a) global
